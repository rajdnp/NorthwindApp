...
namespace NorthwindApp.Migrations
{
    ...
    [Migration("20220430091339_notification")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Category", b =>
                {
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Customer", b =>
                {
                    b.Property<string>("CustomerId")
                        .HasMaxLength(5)
                        .HasColumnType("nchar(5)")
            ...
            modelBuilder.Entity("NorthwindApp.Entities.CustomerDemographic", b =>
                {
                    b.Property<string>("CustomerTypeId")
                        .HasMaxLength(10)
                        .HasColumnType("nchar(10)")
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Employee", b =>
                {
                    b.Property<int>("EmployeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Order", b =>
                {
            ...
            modelBuilder.Entity("NorthwindApp.Entities.OrderDetail", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NorthwindApp.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Region", b =>
                {
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Shipper", b =>
                {
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Territory", b =>
                {
                    b.Property<string>("TerritoryId")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("NorthwindApp.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CustomerCustomerDemo", b =>
                {
                    b.HasOne("NorthwindApp.Entities.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .IsRequired()
                        .HasConstraintName("FK_CustomerCustomerDemo_Customers");

                    b.HasOne("NorthwindApp.Entities.CustomerDemographic", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeTerritory", b =>
                {
                    b.HasOne("NorthwindApp.Entities.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .IsRequired()
                        .HasConstraintName("FK_EmployeeTerritories_Employees");

                    b.HasOne("NorthwindApp.Entities.Territory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Employee", b =>
                {
                    b.HasOne("NorthwindApp.Entities.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Notification", b =>
                {
                    b.HasOne("NorthwindApp.Entities.User", null)
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Order", b =>
                {
                    b.HasOne("NorthwindApp.Entities.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_Orders_Customers");

                    b.HasOne("NorthwindApp.Entities.Employee", "Employee")
                        .WithMany("Orders")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_Orders_Employees");

                    b.HasOne("NorthwindApp.Entities.Shipper", "ShipViaNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("NorthwindApp.Entities.OrderDetail", b =>
                {
                    b.HasOne("NorthwindApp.Entities.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .IsRequired()
                        .HasConstraintName("FK_Order_Details_Orders");

                    b.HasOne("NorthwindApp.Entities.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Product", b =>
                {
                    b.HasOne("NorthwindApp.Entities.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("FK_Products_Categories");

                    b.HasOne("NorthwindApp.Entities.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("NorthwindApp.Entities.RefreshToken", b =>
                {
                    b.HasOne("NorthwindApp.Entities.User", "User")
            ...
            modelBuilder.Entity("NorthwindApp.Entities.Territory", b =>
                {
                    b.HasOne("NorthwindApp.Entities.Region", "Region")
